...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReceiveMessages = channel.unary_stream(
                ...
                response_deserializer=chat__pb2.MessageResponse.FromString,
                _registered_method=True)
        self.SendFile = channel.stream_stream(
                '/chat.ChatService/SendFile',
                request_serializer=chat__pb2.FileRequest.SerializeToString,
                response_deserializer=chat__pb2.FileResponse.FromString,
                _registered_method=True)
        self.ReceiveFile = channel.unary_stream(
                '/chat.ChatService/ReceiveFile',
                request_serializer=chat__pb2.FileRequest.SerializeToString,
                response_deserializer=chat__pb2.FileResponse.FromString,
                _registered_method=True)
        self.DownloadFile = channel.unary_stream(
                '/chat.ChatService/DownloadFile',
                request_serializer=chat__pb2.DownloadFileRequest.SerializeToString,
                response_deserializer=chat__pb2.FileResponse.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendFile': grpc.stream_stream_rpc_method_handler(
                    servicer.SendFile,
                    request_deserializer=chat__pb2.FileRequest.FromString,
                    response_serializer=chat__pb2.FileResponse.SerializeToString,
            ),
            ...
            'DownloadFile': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=chat__pb2.DownloadFileRequest.FromString,
                    response_serializer=chat__pb2.FileResponse.SerializeToString,
            ),
...
class ChatService(object):
    ...
    def SendFile(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            chat__pb2.FileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DownloadFile(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/chat.ChatService/DownloadFile',
            chat__pb2.DownloadFileRequest.SerializeToString,
            chat__pb2.FileResponse.FromString,
            options,
            channel_credentials,
            insecure,
